	...
	//1. 꺾은선 그래프(이용객 추이)
		...
		//		g2.drawLine(sX,230,480,230);//X축. 가로축400 세로축190
				...
				for (int i = 0; i < visitors.length-1; i++) {//렝스에 -1인 이유 = 실행문에 배열[i+1]이 들어가서 배열범위 벗어난 오류
					...
					g2.fillOval(    80+80*i-5, 250-30*visitors[i]-5, 10, 10);
				}//////////////////////////////////////////////////////////////////////////////
				//그래프 2////////////////////////////////////////////////////////////////////////
				int visitors2[] = {2, 4, 3, 6, 5, 5};
				g2.setColor(pastelGreen);
				for (int i = 0; i < visitors2.length-1; i++) {
					g2.drawLine(80+80*i, 250-30*visitors2[i], 80+80*(i+1), 250-30*visitors2[i+1]);
					g2.fillOval(    80+80*i-5, 250-30*visitors2[i]-5, 10, 10);
				}
			}//--paintComponent
		}//--Draw
}
