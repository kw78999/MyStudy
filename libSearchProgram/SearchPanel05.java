...
implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		mgr=new BMEMBERSMgr();
		mgr.idCheck(inputID);//인트(회원번호)를 매개변수로 받는 MID와 MNAME 조회하는 메소드
		...
		if(obj.equals(btn1)&&inputID==mID&&inputName.equals(name)) {
			...
			new VFrame();
		}else if(obj.equals(btn1)&&inputID==-1){
			System.out.println("아이디를 확인하세요 팝업 만들기");
