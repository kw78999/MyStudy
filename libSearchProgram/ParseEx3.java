...
public class ParseEx3{
	...
	public ParseEx3(String test) {//url에 도서명 검색하는 생성자
        ...
        try {
	        ...
	        try{
	            // XML 데이터를 읽어옴
	            URL url = new URL("https://www.nl.go.kr/NL/search/openApi/search.do?key=7523f3fb30bc248452fd33d9d66c72ab188d9394ba612470ca200a6cbaffceb3&detailSearch=true&f1=title&v1="
	            			+ item1+"");
