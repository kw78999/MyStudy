...
<table id ="titleTable"> 
<tr><td colspan="5" height="50px"><b>제목 검색 (총  <%=mgr.getTitleCount(searchKey) %>건)</b></td></tr>
<%
...
<tr><td colspan="5" height="50px"><b>내용 검색 (총  <%=mgr.getContentCount(searchKey) %>건)</b></td></tr>
...
document.write(contentSubstring(textReplace(con,'<%=searchKey%>'))+'...');
</script></td></tr>
