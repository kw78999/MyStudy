...
public class SwingProject_1 extends JTable  implements MouseListener{
	String col[] = {"NO.","서명","저자","출판사","ISBN","도서상태","복본","대출횟수","반입일자"};
	String row[][] ;
	ImageIcon img;
	int cnt =0;
...
public SwingProject_1() {
   ...
   btn.setBounds(99, 0, 30, 30);
    ...
    btn3.setBounds(280, 350, 100, 35);
    btn4.setBounds(405, 350, 100, 35);
...
public void mouseClicked(MouseEvent e) {
	...
	String str6 = (String) table7.getValueAt(table7.getSelectedRow(),7);
